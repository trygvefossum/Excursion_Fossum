...
In the revised manuscript these aspects are largely rewritten into the Introduction, and partly also in Section 2 on the expected integrated Bernoulli variance (EIBV), and partly in the Case Study ({\bf{TO DO 6 AGAIN}}). These changes address some key comments from AE and Rev. 1 in particular.
