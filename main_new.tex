...
This integrand boils down to an evaluation of the
$2\no$-dimensional Gaussian CDF by Proposition~\ref{propo3} (Appendix). Details
are omitted here for brevity as we do not implement this criterion
further because it requires numerical integration over $\domain^2$.
\end{propo}
