...
statistical models. \kc{'Fit' as in modeling fit, or fit for
  augmentation with dynamical models? But also note ocean models are
  unlikely to be able to run onboard, so a simple phrase should be
...
affiliation in an early version of this work.  The authors would also
like to thank Niklas Linde of the University of Lausanne for providing
constructive feedback on a version of the manuscript.
