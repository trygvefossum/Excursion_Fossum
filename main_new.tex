...
$2n_y \times 2n_y$ covariance matrix $\bR$ contains \edcomment{zeroes except on the diagonal entries, which are set to $r^2_T$ and $r^2_S$, holding the measurement error variances of temperature and salinity observations}.
