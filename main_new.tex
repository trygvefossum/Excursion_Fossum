...
\begin{figure}[!h] 
  ...
  \caption{\ref{fig:envir1} Traditional ocean observation based on 
    ...
    effective oceanographic observation.\kc{The inset ``AUV robot''
      looks very tacky and ad-hoc; might be best to remove it. Why not
      add a subfigure of an AUV instead and not lump it into a figure
      which is already quite busy? It can't hurt. Change ``ships'' to
