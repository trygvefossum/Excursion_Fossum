...
buoys, lagrangian float,s or ship-based methods, with significant
...
\begin{itemize}
\item Static sampling paths fail to capture necessary features in dynamic ocean conditions. Incontrast, these approaches make decisions about where to sample  sequentially, i.e.  
