...
and envision that advection-diffusion equations could be useful \citep{sigrist2015stochastic,richardson2017sparsity}. For more complex
...
models. Running large numerical models onboard a robotic vehicle is not currently possible, but high-resolution ocean model or satellite data can be used to fit a more complex statistical model.
