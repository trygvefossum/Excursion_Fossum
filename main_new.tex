...
\begin{figure}[!h] 
  \centering 
  \subfigure[Modern ocean sensing network, where robotic assets augment ship based measurements to increase coverage of the phenomena.]{\includegraphics[width =
