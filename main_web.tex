...
\begin{figure}[!b]
  \centering
  \subfigure[Residual plot.]{\includegraphics[width = 0.32\textwidth]{Figures/res_diag_aNEW.eps}\label{fig:parest_a}}
  \hfill
  \subfigure[Quadratic form CDFs.]{\includegraphics[width = 0.32\textwidth]{Figures/res_diag_bNEW.eps}\label{fig:parest_b}}
  \hfill
  \subfigure[Empirical variogram.]{\includegraphics[width = 0.32\textwidth]{Figures/res_diag_cNEW.eps}\label{fig:parest_c}}
