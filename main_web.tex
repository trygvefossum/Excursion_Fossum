...
and
%
will allow us to think of $\gp$ as a scalar-valued random field indexed by $\domain \times \{1\dots,p\}$, which will give the co-Kriging equations a particularly simple form that parallels the form of univariate Kriging. 
...
EIBV, but we nevertheless anticipate that we will achieve good predictive
performance for other criteria such as RMSE as well. Another non-statistical
